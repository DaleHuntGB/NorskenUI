...
GUIFrame:RegisterContent("CustomSkin_Debuffs", function(scrollChild, yOffset)
    ...
    local enableCheck = GUIFrame:CreateCheckbox(row1, "Enable Custom Debuff Frame", db.Enabled ~= false,
        function(checked)
            db.Enabled = checked
    ...
    local iconSizeSlider = GUIFrame:CreateSlider(row2a, "Icon Size", 16, 100, 1, db.IconSize or 60, nil,
        function(value)
            db.IconSize = value
    ...
    -- Max Rows slider
    local maxRowsSlider = GUIFrame:CreateSlider(row2b, "Max Rows", 1, 10, 1, db.MaxRows or 2, nil,
        function(value)
            db.MaxRows = value
    ...
    local fontSizeSlider = GUIFrame:CreateSlider(row4b, "Count Font Size", 8, 32, 1, db.FontSize or 16, nil,
        function(value)
            db.FontSize = value
            ApplySettings()
        end)
    ...
    -- Timer Font Size
    local timerFontSizeSlider = GUIFrame:CreateSlider(row4b, "Timer Font Size", 8, 40, 1, db.TimerFontSize or 20, nil,
        function(value)
