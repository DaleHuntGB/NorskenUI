...
- **Time Spiral** - Tracks Time Spiral movement ability resets
...
- **Dungeon Casts** - Enemy castbars from nameplates with raid markers and cast targets
- **Healer Mana** - Healer mana display with spec icons
- **Instance Reset** - Announces instance resets to party/raid chat

### Aura Tracking
- **Default Buff & Debuff Tracking** - Default buff and debuff tracking styled
- **Advanced Debuff Tracking** - Customizable debuff display, uses blizzards native filters and non secret auras
...
- **Totem Tracker** - Totem tracker icons
...
- **Bloodlust Tracker** - Bloodlust active icon
- **Spell Alert** - Customize Blizzard proc overlay scale/alpha per spec

### Missing Buffs
- **Missing Buffs** - Tracks missing raid buffs
...
- **Cooldown Strings** - Backup CDM profile strings in savedVariables
...
- **Character Panel** - item upgrade track and gem socketing helper
