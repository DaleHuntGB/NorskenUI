...
function DC:ConfigureBar(bar)
    ...
    NRSKNUI:ApplyFontToText(bar.nameText, NRSKNUI:GetEffectiveFont(barDb), barDb.FontSize, barDb.FontOutline)
    ...
    NRSKNUI:ApplyFontToText(bar.timeText, NRSKNUI:GetEffectiveFont(barDb), barDb.FontSize, barDb.FontOutline)
    ...
    NRSKNUI:ApplyFontToText(bar.targetText, NRSKNUI:GetEffectiveFont(barDb), barDb.FontSize, barDb.FontOutline)
